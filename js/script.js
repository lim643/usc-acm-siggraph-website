...
// function events() {
    // $("#content").hide();
    // $("#li-1").show(0, function () {
    //     $(this).addClass("show-page")
    // })
    // var obj = $("#li-1");
    // obj.html('<div class="grid"><div class="intro"><h1 id="events">Events</h1></div></div>');
    // var str = "";
...
// function news() {
    // $("#content").hide();
    // var obj = $("#li-2");
    // obj.html('<div class="grid"><div class="intro"><h1 id="news">News</h1></div></div>');
    // var str = "";
